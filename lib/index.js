...
const SitemapToFile = function (sitemapUrl, filename) {
  Promise.all([CrawlSitemapUrls(sitemapUrl), CheckIfFileExists(filename)])
    .then(([sitemapUrls, fileExists]) => {
...
// Only needed from another function
